  ...
  >
    <div class="sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-3 text-gray-600">
          ...
          <a
            href="https://nuxtjs.org"
            target="_blank"
            class="button--doc text-green-500 bg-black hover:underline"
            rel="noopener noreferrer"
      ...
      <div>
        ...
        <p class="font-sans text-3xl font-thin">
          Almost before we knew it, we had left the ground.
        </p>
        <p class="font-sans text-3xl font-thin italic">
          Almost before we knew it, we had left the ground.
        </p>
        <p class="font-sans text-3xl font-light">
          Almost before we knew it, we had left the ground.
        </p>
        <p class="font-sans text-3xl font-light italic">
          Almost before we knew it, we had left the ground.
        </p>
        <p class="font-sans text-3xl font-normal">
          Almost before we knew it, we had left the ground.
        </p>
        <p class="font-sans text-3xl font-normal italic">
          Almost before we knew it, we had left the ground.
        </p>
        <p class="font-sans text-3xl font-medium">
          Almost before we knew it, we had left the ground.
        </p>
        <p class="font-sans text-3xl font-medium italic">
          Almost before we knew it, we had left the ground.
        </p>
        <p class="font-sans text-3xl font-bold">
          Almost before we knew it, we had left the ground.
        </p>
        <p class="font-sans text-3xl font-bold italic">
          Almost before we knew it, we had left the ground.
        </p>
        <p class="font-sans text-3xl font-black">
          Almost before we knew it, we had left the ground.
        </p>
        <p class="font-sans text-3xl font-black italic">
          Almost before we knew it, we had left the ground.
        </p>
      </div>
    </div>
